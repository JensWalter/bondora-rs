...
------------ | ------------- | ------------- | -------------
**payload** | [**Vec<crate::models::SecondMarketSaleResponse>**](SecondMarketSaleResponse.md) | The payload of the response. Type depends on the API request. | [optional] [default to null]
